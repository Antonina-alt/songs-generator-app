...
const uiTextByRegion = {
    'en-US': {
        ...
        table: {
            ...
            pagination: {
                displayedRows: (from, to, page) => `${from}–${to}, page ${page}`,
                ariaLabel: {
        ...
        error: {
            seedInputError: 'Enter number from 0 to 18446744073709551615'
        }
    },
    'ru-RU': {
        controls: {
        ...
        table: {
            ...
            pagination: {
                displayedRows: (from, to, page) => `${from}–${to}, страница ${page}`,
                ariaLabel: {
        ...
        error: {
            seedInputError: 'Введите число от 0 до 18446744073709551615'
        }
    }
};
