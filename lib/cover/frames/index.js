const FRAME_RENDERERS = {
    ...
    rounded_label: renderRoundedLabel,
...
function renderRoundedLabel({ width, height, palette }) {
    return `<rect x="44" y="${height - 180}" width="${width - 88}" height="124" rx="28" fill="${palette.background}" stroke="${palette.text}" stroke-width="3" opacity="0.78" />`;
}
