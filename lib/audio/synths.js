...
function createVocalEffects(reverb) {
    const nodes = createVocalEffectNodes();
    connectVocalEffects(nodes, reverb);
    return nodes.compressor;
}

function createVocalEffectNodes() {
    return { compressor: createVocalCompressor(), eq: createVocalEq(), chorus: createVocalChorus(), delay: createVocalDelay() };
}

function connectVocalEffects({ compressor, eq, chorus, delay }, reverb) {
