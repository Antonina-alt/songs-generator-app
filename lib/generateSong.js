...
function createSongMusic({ region, seed, index, musicMeta, lyrics }) {
    const durationSeconds = Math.max(32, getLyricsDurationSeconds(lyrics) + 3);
    return generateMusic({region, seed, index, tempo: musicMeta.tempo, durationSeconds, lyrics});
}
